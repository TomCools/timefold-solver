package ai.timefold.solver.jackson.testutil;
...
import ai.timefold.solver.jackson.testdomain.TestdataSolution;
...
public final class PlannerAssert {
    ...
    public static void verifyPhaseLifecycle(PhaseLifecycleListener phaseLifecycleListener,
        ...
        verify(phaseLifecycleListener, times(solvingCount)).solvingStarted(ArgumentMatchers.any(SolverScope.class));
        verify(phaseLifecycleListener, times(phaseCount)).phaseStarted(ArgumentMatchers.any(AbstractPhaseScope.class));
        verify(phaseLifecycleListener, times(stepCount)).stepStarted(ArgumentMatchers.any(AbstractStepScope.class));
        verify(phaseLifecycleListener, times(stepCount)).stepEnded(ArgumentMatchers.any(AbstractStepScope.class));
        verify(phaseLifecycleListener, times(phaseCount)).phaseEnded(ArgumentMatchers.any(AbstractPhaseScope.class));
        verify(phaseLifecycleListener, times(solvingCount)).solvingEnded(ArgumentMatchers.any(SolverScope.class));
    }
    ...
    public static void verifyPhaseLifecycle(ConstructionHeuristicPhaseLifecycleListener phaseLifecycleListener,
        ...
        verify(phaseLifecycleListener, times(phaseCount))
                .phaseStarted(ArgumentMatchers.any(ConstructionHeuristicPhaseScope.class));
        verify(phaseLifecycleListener, times(stepCount))
                .stepStarted(ArgumentMatchers.any(ConstructionHeuristicStepScope.class));
        verify(phaseLifecycleListener, times(stepCount)).stepEnded(ArgumentMatchers.any(ConstructionHeuristicStepScope.class));
        verify(phaseLifecycleListener, times(phaseCount))
                .phaseEnded(ArgumentMatchers.any(ConstructionHeuristicPhaseScope.class));
        verify(phaseLifecycleListener, times(solvingCount)).solvingEnded(ArgumentMatchers.any(SolverScope.class));
    }
    ...
    public static void verifyPhaseLifecycle(LocalSearchPhaseLifecycleListener phaseLifecycleListener,
            int solvingCount, int phaseCount, int stepCount) {
        verify(phaseLifecycleListener, times(solvingCount)).solvingStarted(ArgumentMatchers.any(SolverScope.class));
        verify(phaseLifecycleListener, times(phaseCount)).phaseStarted(ArgumentMatchers.any(LocalSearchPhaseScope.class));
        verify(phaseLifecycleListener, times(stepCount)).stepStarted(ArgumentMatchers.any(LocalSearchStepScope.class));
        verify(phaseLifecycleListener, times(stepCount)).stepEnded(ArgumentMatchers.any(LocalSearchStepScope.class));
        verify(phaseLifecycleListener, times(phaseCount)).phaseEnded(ArgumentMatchers.any(LocalSearchPhaseScope.class));
        verify(phaseLifecycleListener, times(solvingCount)).solvingEnded(ArgumentMatchers.any(SolverScope.class));
    }
    ...
    public static void assertAllCodesOfValueSelector(IterableValueSelector<?> valueSelector, String... codes) {
        assertAllCodesOfIterableSelector(valueSelector, codes.length, codes);
    }

    public static void assertAllCodesOfValueSelector(IterableValueSelector<?> valueSelector, long size,
            String... codes) {
