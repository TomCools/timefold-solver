open module ai.timefold.solver.core {
    ...
    exports ai.timefold.solver.core.impl.domain.solution to ai.timefold.solver.jackson;
    ...
    exports ai.timefold.solver.core.impl.util
            to ai.timefold.solver.jackson, ai.timefold.solver.test;
    ...
    exports ai.timefold.solver.core.impl.solver
            to ai.timefold.solver.jackson, ai.timefold.solver.spring.boot.autoconfigure;
    exports ai.timefold.solver.core.impl.io.jaxb.adapter to ai.timefold.solver.benchmark;
    exports ai.timefold.solver.core.impl.score.definition to ai.timefold.solver.test;
    exports ai.timefold.solver.core.impl.heuristic.selector to ai.timefold.solver.jackson;
    exports ai.timefold.solver.core.impl.heuristic.selector.entity to ai.timefold.solver.jackson;
    exports ai.timefold.solver.core.impl.heuristic.selector.entity.pillar to ai.timefold.solver.jackson;
    exports ai.timefold.solver.core.impl.heuristic.selector.move to ai.timefold.solver.jackson;
    exports ai.timefold.solver.core.impl.heuristic.selector.value to ai.timefold.solver.jackson;
    exports ai.timefold.solver.core.impl.localsearch.event to ai.timefold.solver.jackson;
    exports ai.timefold.solver.core.impl.phase.event to ai.timefold.solver.jackson;
    exports ai.timefold.solver.core.impl.phase.scope to ai.timefold.solver.jackson;
